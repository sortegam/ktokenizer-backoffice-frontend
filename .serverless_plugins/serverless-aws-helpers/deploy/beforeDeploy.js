...
const beforeDeploy = async () => {
  if (!availableStages || availableStages.length === 0) {
    console.log('----------------------------------------------------------------------'.red);
    console.log(
      'No available stages, to create a new stage run > '.red + 'sls awshelpers newstage'.cyan.bold
    );
    console.log('----------------------------------------------------------------------'.red);
    process.exit(1);
  }
  ...
  console.log('');
  console.log(`To manage Stages run > ${'sls awshelpers stages'.cyan.bold}`);
  console.log('');
